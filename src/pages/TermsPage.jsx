          ...
          >
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-charcoal-600 leading-relaxed mb-6">
                By accessing and using the services provided by MediaPerformanceInsights.com, 
                you accept and agree to be bound by the terms and provision of this agreement.
              </p>

              <h2 className="text-2xl font-bold text-charcoal-900 mt-12 mb-6">Services Description</h2>
              <p className="text-charcoal-600 leading-relaxed mb-6">
                MediaPerformanceInsights.com provides strategic media performance analysis, 
                consulting services, and communication training for professionals and organizations.
              </p>
              ...
              <p className="text-charcoal-600 leading-relaxed mb-6">
                All frameworks, methodologies, and materials developed by MediaPerformanceInsights.com 
                remain our intellectual property. Clients receive a license to use provided materials 
                for their personal or organizational communication purposes.
              </p>

              <h2 className="text-2xl font-bold text-charcoal-900 mt-12 mb-6">Confidentiality</h2>
              <p className="text-charcoal-600 leading-relaxed mb-6">
                We maintain strict confidentiality regarding all client information, media content, 
                and strategic discussions. This confidentiality extends indefinitely beyond the 
                completion of services.
              </p>

              <h2 className="text-2xl font-bold text-charcoal-900 mt-12 mb-6">Limitation of Liability</h2>
              <p className="text-charcoal-600 leading-relaxed mb-6">
                MediaPerformanceInsights.com provides strategic analysis and recommendations. 
                The implementation and results of these recommendations remain the responsibility 
                of the client. We cannot guarantee specific outcomes from media appearances or 
              ...
              <p className="text-charcoal-600 leading-relaxed mb-6">
                ...
                individual service agreements. Confidentiality obligations survive termination.
              </p>

              <h2 className="text-2xl font-bold text-charcoal-900 mt-12 mb-6">Changes to Terms</h2>
              <p className="text-charcoal-600 leading-relaxed mb-6">
                We reserve the right to modify these terms at any time. Changes will be 
                communicated to active clients and posted on our website.
              </p>
