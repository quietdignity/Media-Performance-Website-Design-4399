      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-charcoal-200 max-w-3xl mx-auto mb-8 leading-relaxed">
            Every executive's media challenges are unique. Investment and timeline are determined during our initial consultation based on your specific situation, urgency, and desired outcomes.
          </p>
          
          <p className="text-xl md:text-2xl text-charcoal-200 max-w-3xl mx-auto mb-12 leading-relaxed">
            Schedule your complimentary consultation to discover how comprehensive media performance analysis can transform your executive presence.
          </p>
          ...
          >
            ...
            <h3 className="text-xl font-bold text-white mb-4">Schedule Your Strategic Consultation</h3>
            <p className="text-charcoal-200 mb-6">
              Book a comprehensive session to discuss your specific media goals, analyze your current performance, and develop a strategic roadmap for commanding media presence.
            </p>
            <motion.a
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <span className="text-charcoal-400">Ready to get started?</span>
              <motion.a
                href="https://tidycal.com/jamesbrowntv/media-performance-insights-consultations"
                target="_blank"
                rel="noopener noreferrer"
